...
from web_dashboard.api.model_training_status import router as model_training_status_router
...
api_router.include_router(model_training_status_router, tags=["model-training"])
...
api_router.include_router(system_audit_router, tags=["system-audit"])
