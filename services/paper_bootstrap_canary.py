"""Compatibility and settlement controls for previously created paper canaries.

New entries use the normal trained-strategy return and risk pipeline.  This module
only validates already persisted canary decisions and safely manages legacy sample
positions until they are settled.
"""
