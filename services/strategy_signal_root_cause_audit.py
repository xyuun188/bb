...
def _cause_message(code: str) -> str:
    return {
        ...
        "production_trade_gate_missing": "The authoritative production trade gate is missing.",
        "production_trade_gate_version_invalid": "The production trade gate version is invalid.",
        "production_trade_gate_closed": "The production trade gate is closed.",
        "production_trade_gate_mode_invalid": "The production trade gate mode is invalid.",
        "production_trade_gate_mode_mismatch": "The production trade gate mode does not match this contract.",
        "production_trade_gate_authority_invalid": "The production trade gate authority contract is invalid.",
