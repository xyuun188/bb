...
NORMAL_ENTRY_SCORE_THRESHOLD = 0.42
PROBE_ENTRY_SCORE_THRESHOLD = 0.26
PROBE_ENTRY_ENABLED = True
MAX_ENTRY_DISAGREEMENT = 0.50
...
REVIEW_CLOSE_STRONG_CONFIDENCE = 0.65
REVIEW_STRONG_OPPOSITE_SCORE = 0.45
PROFIT_PROTECT_REDUCE_PNL_RATIO = 0.004
PROFIT_PROTECT_STRONG_PNL_RATIO = 0.010
PROFIT_PROTECT_FULL_PNL_RATIO = 0.018
PROFIT_PROTECT_MIN_LOCK_USDT = 1.50
PROFIT_PROTECT_STRONG_MIN_LOCK_USDT = 2.50
...
LOSS_FULL_MIN_RISK_USAGE = 0.82
FAST_PROFIT_MIN_HOLD_MINUTES = 6.0
QUICK_PROFIT_REDUCE_PNL_RATIO = 0.008
CAPITAL_ROTATION_PROFIT_PNL_RATIO = 0.012
QUICK_PROFIT_FULL_PNL_RATIO = 0.020
PROFIT_LOCK_FEE_MULTIPLE = 4.0
PROFIT_LOCK_NOTIONAL_RATIO = 0.0025
PROFIT_LOCK_RISK_RATIO = 0.18
PROFIT_LOCK_MIN_FLOOR_USDT = 0.25
PROFIT_LOCK_MAX_FLOOR_USDT = 8.0
PROFIT_LOCK_MEANINGFUL_REDUCE_USDT = 3.0
PROFIT_LOCK_REDUCE_FEE_MULTIPLE = 10.0
PROFIT_LOCK_REDUCE_NOTIONAL_RATIO = 0.008
PROFIT_LOCK_REDUCE_RISK_RATIO = 0.16
PORTFOLIO_FOCUS_LOCK_MIN_USDT = 3.0
PORTFOLIO_FOCUS_LOCK_MIN_SHARE = 0.20
PORTFOLIO_FOCUS_LOCK_REDUCE_SIZE = 0.35
PROFIT_RETRACE_PEAK_LINE_MULTIPLE = 1.15
PROFIT_RETRACE_CURRENT_LINE_MULTIPLE = 0.25
PROFIT_RETRACE_BASE_REDUCE_RATIO = 0.24
PROFIT_RETRACE_BASE_FULL_RATIO = 0.52
PROFIT_RETRACE_MIN_REDUCE_RATIO = 0.16
PROFIT_RETRACE_MAX_REDUCE_RATIO = 0.40
PROFIT_RETRACE_MIN_FULL_RATIO = 0.42
PROFIT_RETRACE_MAX_FULL_RATIO = 0.72
ADD_POSITION_MIN_SUPPORT = 2
ADD_POSITION_MIN_CONFIDENCE = 0.60
ADD_POSITION_STRONG_CONFIDENCE = 0.68
ADD_POSITION_SCORE_THRESHOLD = 0.32
ADD_POSITION_MIN_PROFIT_RATIO = 0.002
ADD_POSITION_MAX_RISK_USAGE = 0.20
ADD_POSITION_MIN_SIZE = 0.02
ADD_POSITION_MAX_SIZE = 0.06
WINNER_EXPAND_MIN_UNREALIZED_USDT = 1.2
WINNER_EXPAND_MIN_PROFIT_RATIO = 0.0012
WINNER_EXPAND_SCORE_THRESHOLD = 0.18
WINNER_EXPAND_MAX_RISK_USAGE = 0.25
WINNER_RUN_MIN_PROFIT_RATIO = 0.001
LOSS_COMPRESS_REDUCE_USDT = 3.0
LOSS_COMPRESS_FULL_USDT = 8.0
LOSS_COMPRESS_REDUCE_RATIO = 0.006
LOSS_COMPRESS_FULL_RATIO = 0.012
LOSS_COMPRESS_REDUCE_RISK_RATIO = 0.35
LOSS_COMPRESS_FULL_RISK_RATIO = 0.65
LOSS_REPAIR_MAX_LOSS_PROBABILITY = 0.54
LOSS_EXPAND_MIN_LOSS_PROBABILITY = 0.55
LOSS_EXPAND_FULL_LOSS_PROBABILITY = 0.61
LOSS_REPAIR_REDUCE_SUPPORT_COUNT = 2
LOSS_REPAIR_FULL_SUPPORT_COUNT = 3
PREDICTIVE_REVERSAL_REVIEW_SCORE = 38.0
PREDICTIVE_REVERSAL_EXIT_SCORE = 60.0
PREDICTIVE_REVERSAL_FULL_EXIT_SCORE = 78.0
PREDICTIVE_REVERSAL_REDUCE_SIZE = 0.60
ML_MIN_EXPECTED_RETURN_PCT = 0.05
ML_MIN_PROFIT_EDGE_PCT = 0.02
ML_MIN_SUPPORT_WIN_RATE = 0.0
ML_STRONG_SUPPORT_WIN_RATE = 0.0
ML_SUPPORT_CONFIDENCE_BONUS = 0.02
ML_LOW_EDGE_CONFIDENCE_BONUS = 0.06
ML_LOW_WIN_CONFIDENCE_BONUS = 0.08
ML_PROFIT_FIRST_SCORE_RELIEF = 0.08
ML_PROFIT_FIRST_MIN_EXPECTED_RETURN_PCT = 0.12
ML_PROFIT_FIRST_MIN_EDGE_PCT = 0.08
ML_QUANT_ONLY_MIN_EXPECTED_RETURN_PCT = 0.10
ML_QUANT_ONLY_MIN_EDGE_PCT = 0.18
ML_QUANT_ONLY_MAX_LOSS_PROBABILITY = 0.60
