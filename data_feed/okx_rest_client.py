...
class OKXRestClient:
    ...
    async def fetch_ticker(self, symbol: str) -> dict:
        return await self._ccxt_call("fetch_ticker", self._to_swap_symbol(symbol))

    async def fetch_tickers(self, symbols: list[str] | None = None) -> dict:
        swap_symbols = [self._to_swap_symbol(s) for s in symbols] if symbols else None
        return await self._ccxt_call("fetch_tickers", swap_symbols)
    ...
    async def fetch_order(self, order_id: str, symbol: str) -> dict:
        return await self._ccxt_call("fetch_order", order_id, symbol)
