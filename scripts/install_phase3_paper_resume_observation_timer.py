#!/usr/bin/env python3
"""Install the online systemd timer for Phase 3 paper-resume observation."""
...
REMOTE_OWNER = "bb:bb"
SERVICE_NAME = "bb-phase3-paper-resume-observation.service"
TIMER_NAME = "bb-phase3-paper-resume-observation.timer"
REMOTE_RUNTIME_ENV_PATH = "/etc/bb/bb-runtime.env"
REPORT_DIR_REL = "data/phase3_paper_resume_observation_reports"
DEFAULT_ON_CALENDAR = "*-*-* *:07,37:00"
...
def render_service(
    *,
    ...
    return f"""[Unit]
Description=BB Phase 3 paper-resume observation report
...
def render_timer(*, on_calendar: str = DEFAULT_ON_CALENDAR) -> str:
    return f"""[Unit]
Description=Run BB Phase 3 paper-resume observation report
